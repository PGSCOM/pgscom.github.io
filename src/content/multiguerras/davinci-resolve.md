...
### Composición
Con los metadatos extraídos desde Unreal a CSV (proceso explicado [aquí](#emparejamiento-de tomas-reales-y-virtuales)) se metían las dos tomas con el mismo metadato de escena en una secuencia multicamara y luego se copia a una timeline donde se aplica la pantalla verde y VFX que necesite esa escena.
