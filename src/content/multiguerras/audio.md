...
Esperé a montar todo el cortometraje para editar el sonido. Casi todo el sonido lo hice con [Ableton Live](https://www.ableton.com/es/live/), donde importé una previsualización de cada grupo de escenas del cortometraje.

## Banda sonora y efectos de sonido
En cuanto a la Banda Sonora Original, la hicimos con diversos VSTs como Kontakt y demás. La mayor parte de las canciones fueron compuestas e interpretadas por Encarnación Arce; yo ejercí de productor y la guié en Ableton, que ella no había utilizado antes. La canción final fue la única que compuse íntegramente yo, que está construida a base de configurar sintetizadores.
