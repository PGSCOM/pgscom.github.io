...
Para que la cámara virtual de Unreal tuviera el mismo campo de visión que el iPhone 12 real, hice una hoja de cálculo con el ancho y alto real del sensor de cada lente (principal, 0.5x y 2.5x). Esos valores de sensor se copian y pegan directamente en los parámetros de la cámara de Unreal, así el encuadre virtual coincide con el de la cámara que graba a los actores.
