...
Se hizo con el sistema de físicas Niagara Fluids importando la mesh que montaba el [portal de Blender](#portal-en-blender). Y después lo metí en un Blueprint Class junto a su iluminación para crear un Blueprint instanciable.
...
Al principio, se usaron los personajes y animaciones de [Mixamo](https://mixamo.com/) que se colocaban manualmente en cada escena.
...
<video controls src="/proyvid/multiguerras/crowdmuroberlin.mp4" style="width: 40%;"></video>
...
<video controls src="/proyvid/multiguerras/metahumanfreiheit.mp4"></video>
